...
export default class BackgroundPicture extends Component {
    ...
    render() {
      ...
      if (style.opacity > 0.9 ) {
        ...
        const id = "url(#"+this.props.id+")";
        const link = "http://malek.ovh/rwc/resources/Img/" + this.props.image;
        const side = "backgroundOne "+ this.props.align;
      ...
      return (
                ...
                <div style={style} className={side}>
                    ...
                    <defs>
                        <pattern id={this.props.id} x="0" y="0" height="100%" width="100%" >
                            <image x="0" y="0"  height="800px"  xlinkHref={link}></image>
                        </pattern>
                     </defs>
                        <polygon points={this.props.points} fill={id} stroke="white" strokeWidth="3" />
                    </svg>
              </div>
