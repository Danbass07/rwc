        ...
        return (
            ...
            <Navigation />
                ...
                <div className="MainContainer">
                    ...
                    <div className="Cell">
                    <Rounddiv image={"logo.jpg"} position={this.state.currentScrollPosition} min={650} max={1500} side={'left'}/>
                    </div>
                    <div className="Cell">
                        <div className="Text">
                    ...
                    <div className="Cell">
                    <Rounddiv image={"logo.jpg"} position={this.state.currentScrollPosition} min={650} max={1500} side={'right'}/>
                    </div>  
